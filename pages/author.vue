    ...
    <div class="space-y-6">
      ...
      <div class="bg-white rounded-lg shadow-sm border">
        ...
        <div class="p-6">
          ...
          >
            <div class="relative">
              ...
              >
                ...
                Add Block
                <svg
                  class="w-4 h-4 ml-2 transform rotate-180"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              >
                <div class="py-1">
                  ...
                  <button
                    class="flex items-center w-full px-4 py-2 text-sm text-gray-500 cursor-default"
                  >
            ...
            <div>
              ...
              <div class="bg-gray-50 rounded-lg p-6">
                <p class="text-sm text-gray-600 mb-6">
                  Select the type of activity you wish to insert here.
                </p>
                ...
                <div class="grid grid-cols-4 gap-[6rem] mb-8">
                  ...
                  <div>
                    ...
                    <div class="space-y-4">
                      <button
                        class="w-full p-4 border-2 border-dashed border-gray-300 rounded-lg hover:border-gray-400 focus:outline-none focus:border-purple-500 disabled:opacity-50 disabled:cursor-not-allowed text-center"
                        disabled
                      >
                        ...
                        >
                          <path
                            ...
                            stroke-linejoin="round"
                            stroke-width="2"
                            d="M9 5H7a2 2 0 00-2 2v10a2 2 0 002 2h2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"
                          ></path>
                        </svg>
                      </button>
                      <button
                  ...
                  <div>
                    ...
                    <div class="space-y-4">
                      ...
                      >
                        ...
                        <svg
                          class="w-8 h-8 mx-auto text-purple-600"
                          fill="none"
                          stroke="currentColor"
                          viewBox="0 0 24 24"
                        >
          ...
          <div v-if="selectedDoc && !isLoadingDocument">
            <div>
              ...
              <div class="bg-white rounded-lg">
                ...
                <div class="border-t border-gray-200">
                  <button
                    ...
                    "
                    :class="[
                      'inline-flex items-center mt-4 px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium transition-colors',
                      currentStep !== steps.AUTHOR_ADD_DOC &&
                      currentStep !== steps.AUTHOR_PREVIEW
          ...
          >
            ...
            <div class="flex items-center space-x-3">
              ...
              <span class="text-sm text-blue-700"
                >Teacher is currently reviewing student work</span
              >
            </div>
          </div>
        </div>
        ...
        <div class="text-center py-8">
          ...
          >
            ...
            <div class="text-left text-sm text-purple-700">
              ...
              <p>
                👨‍🏫 <strong>Teacher Reviewed:</strong> Final review completed
              </p>
