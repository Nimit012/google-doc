<template>
    <div class="space-y-6">
      ...
      <div v-if="!selectedDocument" class="bg-white rounded-lg shadow-sm border p-6">
        <h2 class="text-xl font-semibold mb-4">Select Assignment Document</h2>
      ...
      <div v-if="selectedDocument && !confirmed" class="bg-white rounded-lg shadow-sm border p-6">
        <h2 class="text-xl font-semibold mb-4">Confirm Assignment Document</h2>
  ...
  const handleDocumentSelected = (docData) => {
    console.log('📄 Document selected by author:', docData)
  ...
  const confirmSelection = () => {
    if (selectedDocument.value) {
      ...
      console.log('✅ Document confirmed by author:', selectedDocument.value)
