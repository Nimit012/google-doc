  ...
  <div>
    ...
    <div class="bg-white rounded-lg shadow-sm border p-6 mb-6">
      <div class="flex items-center justify-between mb-4">
        <h3 class="text-lg font-semibold text-gray-900">Assignment Document Preview</h3>
        <button 
          @click="previewOriginalDocument"
      ...
      <!-- Loading state -->
      <div v-if="isLoadingPreview" class="bg-gray-50 rounded-lg p-8 flex items-center justify-center">
      ...
      <div v-else-if="documentPreview" class="space-y-4">
        ...
        <div class="bg-gray-50 rounded-lg p-4">
          <div class="flex items-center space-x-3">
            ...
            <div>
              <h4 class="font-medium text-gray-900">{{ documentPreview.name }}</h4>
              <p class="text-sm text-gray-600">Original Document • Last modified {{ documentPreview.modifiedTime }}</p>
            </div>
          </div>
        </div>
        ...
        <div v-if="documentThumbnail" class="bg-gray-50 rounded-lg p-4">
          <h4 class="text-sm font-medium text-gray-700 mb-3">Document Preview:</h4>
        ...
        <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          <div class="flex items-start space-x-2">
            ...
            <div>
              <h4 class="text-sm font-medium text-yellow-800 mb-1">Preview Only</h4>
              <p class="text-sm text-yellow-700">
                This is the original document that will be copied for your assignment. 
                You'll receive your own editable copy when you start the assignment.
              </p>
            </div>
          </div>
        </div>
      ...
      <div v-else-if="previewError" class="bg-red-50 border border-red-200 rounded-lg p-4">
        <div class="flex items-center space-x-2">
          ...
          <span class="text-sm font-medium text-red-800">Unable to load document preview</span>
        </div>
...
const loadDocumentPreview = async () => {
  ...
  try {
    ...
    previewError.value = 'Document preview unavailable. You can still start the assignment.'
  } finally {
